...
@pytest.mark.asyncio
async def test_pipeline_produces_three_datasets(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_datasets_are_dataframes(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_calls_fetcher_with_year(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_athletes_df_not_empty(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_contests_df_not_empty(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_merged_df_has_role_column(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_creates_selected_output_format(
    mock_fetcher, tmp_path
):
...
@pytest.mark.asyncio
async def test_pipeline_creates_sqlite_output(
    mock_fetcher, tmp_path
):
